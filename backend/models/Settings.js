...
const settingsSchema = new mongoose.Schema({
  companyName: { type: String, default: 'Aura Luxury Travels 2026' },
  logoUrl: { type: String, default: '/logo.png' },
  contactEmail: { type: String, default: 'concierge@auratravels.com' },
  ...
  registrationNo: { type: String, default: 'REG-2026-LUX-9981' },
